...
const About = () => {
    return (
        <>
            <div id='project' className="mt-10 marg sm:mx-16 md:mx-10 lg:mx-40 sm:mt-0">
                <div className='text-center sm:pt-10'>
                    <h1 className='inline-block text-white border-b-4 border-yellow-500 rounded-lg font '>Project</h1>
                </div>
